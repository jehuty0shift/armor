...
public class AliasLifeCycleFilter extends AbstractActionFilter {
    ...
    private static class AliasLifeCycleListener<Response extends ActionResponse> implements ActionListener<Response> {
        ...
        public AliasLifeCycleListener(final List<IndicesAliasesRequest.AliasActions> aliasActions, final EngineUser engineUser, final KafkaEngineService kafkaEngineService, final ActionListener origListener, final ObjectMapper mapper, final ClusterService clusterService, final ThreadContext threadContext) {
