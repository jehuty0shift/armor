...
public final class ArmorPlugin extends Plugin implements ActionPlugin, NetworkPlugin, IngestPlugin {
    ...
    public List<Setting<?>> getSettings() {
        ...
        settings.add(Setting.listSetting(ConfigConstants.ARMOR_INDEX_LIFECYCLE_USER_WHITELIST, Collections.emptyList(), Function.identity(), Setting.Property.NodeScope, Setting.Property.Filtered));
        ...
        settings.add(Setting.listSetting(ConfigConstants.ARMOR_ALIAS_LIFECYCLE_USER_WHITELIST, Collections.emptyList(), Function.identity(), Setting.Property.NodeScope, Setting.Property.Filtered));
