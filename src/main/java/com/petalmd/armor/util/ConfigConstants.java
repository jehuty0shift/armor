...
public final class ConfigConstants {
    ...
    public static final String ARMOR_KAFKA_ENGINE_SERVICE_VAULT_CLUSTER_PREFIX = "armor.kafka_engine.vault.cluster_prefix";
    public static final String ARMOR_KAFKA_ENGINE_SERVICE_VAULT_ENABLED = "armor.kafka_engine.vault.enabled";
    public static final String ARMOR_KAFKA_ENGINE_SERVICE_VAULT_AUTH = "armor.kafka_engine.vault.auth";
