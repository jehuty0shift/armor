...
public class EncryptedMongoDBAuthBackendTest {


    private SivMode SIV_MODE;
    private static final Logger log = LogManager.getLogger(EncryptedMongoDBAuthBackendTest.class);

    @Before
    public void configureSIV() {
        if (SIV_MODE == null) {
